            ...
            <DialogTitle sx={{textAlign: "center"}}>Artist Details</DialogTitle>
              <Box
                ...
                <Card sx={{ display: "flex" }}>
                   ...
                   {/*  <Grid>
                    <Typography variant="h6" sx={{ textAlign: "center", mt: 2, color: "#a6a6a6", fontSize: "20px" }}>Albums</Typography>
                    <Typography variant="h6" sx={{ textAlign: "center", color: "#008037", }}>{data.album_name}</Typography>
                    </Grid> */}
                        </>
